            ...
            do
            {
                ...
                switch (option)
                {
                    ...
                    case 4:
                        ...
                        Console.WriteLine(account1.AccountNumber);
                        Console.WriteLine(account2.AccountNumber);
                        int selectAccount = int.Parse(Console.ReadLine());
                        double withdrawAmount;

                        if (selectAccount == account1.AccountNumber)
                        {
                        ...
                        else if (selectAccount == account2.AccountNumber)
                        {
                            Console.WriteLine("\nEnter a Withdrawl Amount: ");
                            withdrawAmount = double.Parse(Console.ReadLine());
                    ...
                    case 5:
                        ...
                        int finalSelection = int.Parse(Console.ReadLine());
                        Console.WriteLine();
                    ...
                    case 11:
                        ...
                        Console.WriteLine("- " + student1.Name);
                        Console.WriteLine("- " + student2.Name);
                        string pickStudent = Console.ReadLine();

                        Student studentSelected;
                        if (pickStudent == student1.Name)
                        {
